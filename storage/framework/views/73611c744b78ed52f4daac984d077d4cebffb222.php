        ...
        <nav id="main-menu-navigation" style="margin-bottom: 300px" class="navigation-main">
            <?php if(auth()->guard('admin')->check()): ?>
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item">Alerts</a>
                    </div>
                </div>
                <div class="nav-item has-sub">
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item"></a>
                    </div>
                </div>
                <div class="nav-item has-sub">
            ...
            <?php if(auth()->guard('student')->check()): ?>
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item">Điểm bài test</a>
                    </div>
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item">Điểm kiểm tra</a>
                    </div>
                </div>
                <div class="nav-item">
            ...
            <?php if(auth()->guard('teacher')->check()): ?>
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item"> Nhập điểm bài test</a>
                    </div>
                    <div class="submenu-content">
                        <a href="<?php echo e(asset('admins/pages/ui/alerts.html')); ?>" class="menu-item"> Nhập điểm kiểm tra</a>
                    </div>
                </div>
                <div class="nav-item">
                    <a href="#"><i class="ik ik-check-square"></i><span> Điểm danh</span></a>
...
<?php /**PATH C:\xampp\htdocs\du-an-tot-nghiep\du-an-tot-nghiep\resources\views/layout/_share/sidebar.blade.php ENDPATH**/ ?>