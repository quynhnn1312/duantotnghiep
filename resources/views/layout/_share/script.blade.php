...
{{--<script src="{{ asset('admins/plugins/jvectormap/jquery-jvectormap.min.js')}}"></script>--}}
{{--<script src="{{ asset('admins/plugins/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js')}}"></script>--}}
...
{{--<script src="{{ asset('admins/js/widgets.js')}}"></script>--}}
