            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ asset('frontends/img/blog/feature-img2.jpg')}}" alt="" />
                            </div>
                            <a class="posts-title" href="blog-single.html">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ asset('frontends/img/blog/feature-img3.jpg')}}" alt="" />
                            </div>
                            <a class="posts-title" href="blog-single.html">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ asset('frontends/img/blog/feature-img4.jpg')}}" alt="" />
                            </div>
                            <a class="posts-title" href="blog-single.html">
                                <h3>The Night Sky</h3>
                            </a>
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ asset('frontends/img/blog/feature-img5.jpg')}}" alt="" />
                            </div>
                            <a class="posts-title" href="blog-single.html">
                        ...
                        <div class="single-sidebar-widget search-widget">
                            <form class="search-form" action="#">
                                <input placeholder="Search Posts" name="search" type="text"
                                       ...
                                       data-cf-modified-dcfba0bbaaa57af838eff4b2-="" />
